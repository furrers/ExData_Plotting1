...
##Plot 4 creation and save as PNG 
...
with(sub_table, {
  ...
  plot(Day, Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab="")
  lines(sub_table$Day, sub_table$Sub_metering_2, col = "red")
  lines(sub_table$Day, sub_table$Sub_metering_3, col = "blue")
  legend("topright", cex = 0.95, c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), bty="n",lty = 1,col = c("black", "red", "blue"))
